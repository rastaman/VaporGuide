...
<body>
	...
	<h4><a href="${pageContext.request.contextPath}/artist/manage.html">Artists</a> -> ${artist.name} : Edit</h4><br/>
	
	<form:form method="POST" commandName="artist"
		action="${pageContext.request.contextPath}/artist/edit/${artist.id}.html">
		<table>
			<tbody>
				<tr>
		...
		<a class="btn btn-default" href="${pageContext.request.contextPath}/artist/manage.html" role="button">
			Cancel
		</a> 
