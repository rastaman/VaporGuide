...
<body>
	...
	<a href="${pageContext.request.contextPath}/song/manage/${album.id}.html">${album.name}</a> ->
	${song.name} : Edit</h4><br/>
	
	<form:form method="POST" commandName="song"
		action="${pageContext.request.contextPath}/song/edit/${song.id}.html">
		<table>
			<tbody>
				<tr>
					<td><b>Song Name: &nbsp;</b></td>
					<td><form:input path="name" /></td>
					<td><form:hidden path="album_id" value="${album.id}"/></td>
				</tr>
			</tbody>
		</table>
		<br/>
